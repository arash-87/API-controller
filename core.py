                ...
                if SRV_UP == True:
                    ...
                    try:
                        ...
                        try:
                            ...
                            output = list_hotspot.get(id='*1') [0]["id"] 
							# To see all the parametrs of /ip/hotspot, remove everything in () and the following
                            print(">>> Hotspot ID: ", output) 
                            
                            # Set new data to router(s) using the parameter of "disbaled"
                            # true: hotsput disable // false: enable hotspot
                            list_hotspot.set(id=output,disabled='true')
